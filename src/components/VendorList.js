          ...
          <div className="p-6">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-400 mb-6">Get started by creating your first vendor</p>
                <button
                  onClick={() => {
                    setSelectedVendor(null);
                    setShowVendorForm(true);
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {vendors.map((vendor) => (
                      <tr key={vendor.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{vendor.is_verified ? 'Yes' : 'No'}</td>
